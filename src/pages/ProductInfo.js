...
import PalletColor from "../components/BasicComponents/PalletColor";
import ProductionPlan from "../components/Products/ProductionPlan";
                ...
                .then(urls => {
                    loadDataItem('products', {
                        ...
                        .then((newProduct) => {
                            ...
                            uploadData("production-processes", newProcesses);
                        });
                }).catch(error => {
